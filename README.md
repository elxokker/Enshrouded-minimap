...
[Enshrouded Minimap v0.4.42](https://github.com/elxokker/Enshrouded-minimap/releases/tag/v0.4.42)

Release asset:

`enshrouded-minimap-v0.4.42.zip`

## Installing the Zip

1. Close Enshrouded.
2. Download `enshrouded-minimap-v0.4.42.zip`.
3. Extract the zip.
